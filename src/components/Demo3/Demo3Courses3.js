...
const Demo3Courses3 = () => {
    ...
    useEffect(() => {
        pagination("#demo3courses3", sort, active);
        let list = document.querySelectorAll("#demo3courses3");
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="section-title mb-60">
                                {/* Title 	*/}
                                <h4 className="h4-xl">Highest Rated Online Courses</h4>
                                {/* Text */}
                                <p className="p-md">
                                ...
                                <div className="title-btn">
                                    <Link href="/courses-list"
                                        className="btn btntra-grey rose-hover">
                                        View All Courses
