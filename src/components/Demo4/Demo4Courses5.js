                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="section-title mb-40">
                            {/* Title 	*/}
                            <h3 className="h3-sm">Our Best Courses of 2019</h3>
                            {/* Text */}
                            <p className="p-md">
