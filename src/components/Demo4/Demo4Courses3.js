...
const Demo4Courses3 = () => {
    ...
    useEffect(() => {
        pagination("#demo4courses3", sort, active);
        let list = document.querySelectorAll("#demo4courses3");
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="section-title mb-40">
                                {/* Title 	*/}
                                <h3 className="h3-sm">All Language Courses</h3>
                                {/* Text */}
                                <p className="p-md">
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3">
                            <div className="cbox-1">
                                <Link href="/course-details">
                                    ...
                                    <img
                                        className="img-fluid"
                                        src="images/courses/course-22-img.jpg"
                                        alt="course-preview"
                                    />
                                    {/* Text */}
                                    <div className="cbox-1-txt">
                                        ...
                                        {/* Title */}
                                        <h5 className="h5-xs">
                                            Complete Spanish Course: Learn Spanish | Beginners
                                        </h5>
                                        {/* Course Rating */}
                                        <div className="course-rating clearfix">
                                            <i className="fas fa-star" />
