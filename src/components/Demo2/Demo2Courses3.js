...
const Demo2Courses3 = () => {
    ...
    useEffect(() => {
        pagination("#demo2courses3", sort, active);
        let list = document.querySelectorAll("#demo2courses3");
                        ...
                        <div className="col-md-12">
                            <div className="section-title mb-60">
                                ...
                                <div className="title-btn">
                                    <Link href="/courses-list" className="btn btn-tra-grey rose-hover">
                                            View All Courses 
                                    </Link>
                                </div>
                            </div>
