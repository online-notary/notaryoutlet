                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="section-title title-centered mb-80">
                            ...
                            {/* Button 
									<div class="title-btn">
										<Link href='/categories-list'> className='btn btn-tra-grey rose-hover'>Browse All Categories</Link>
									</div> */}
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="all-courses-btn">
                            <Link href="/categories-list" className="btn btn-tra-grey rose-hover">
...
export default Aboutcategories4;
